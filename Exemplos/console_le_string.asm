...
; A TRAP 3 da 0981-video grava no maximo 127 bytes de texto
; e acrescenta um byte zero. Linhas maiores sao truncadas.
;---------------------------------------------------
ORG 100
BUFFER:  DS   128        ; 127 bytes de texto + terminador zero
PROMPT:  STR  "> "
         DB   0
CR:      DB   0Dh
LF:      DB   0Ah
