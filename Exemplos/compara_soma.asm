;---------------------------------------------------
; Entradas sem sinal (0-255). Opcoes: 0 maior, 1 menor,
; 2 soma, 3 diferenca N1-N2; outra opcao mostra FF.
; Soma e diferenca sao resultados de 8 bits (modulo 256).
...
STATUS    EQU     1
VISOR     EQU     0
FIM_PILHA EQU     0x100   ; 256: fora do codigo; EQU nao aceita sufixo H
          END     INICIO
