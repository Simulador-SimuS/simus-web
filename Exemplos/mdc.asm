...
; Aceita bytes sem sinal (0-255). MDC(A,0) = A.
; Para a entrada (0,0), este exemplo convenciona resultado 0.
;---------------------------------------------------
ORG 100
A:      DS  1
B:      DS  1
...
RESTO:  LDA  R
        SUB  B
        JC   PROXIMO    ; Empréstimo: R < B (comparação sem sinal)
        STA  R          ; Salva o resultado, inclusive quando é zero
        JZ   PROXIMO    ; Divisão exata: R = 0 já foi salvo
        JMP  RESTO
