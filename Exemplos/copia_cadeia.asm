...
DESTINO:     DS   20
STACK:       DS   31      ; Primeiros 31 bytes reservados para a pilha
STACK_ADDR:  DS   1       ; Ultimo byte: PUSH grava aqui antes de decrementar
;-------------------------------------------------
; Rotina STRCOPY
; Na pilha: os enderecos de origem e destino (16 bits cada).
; Copia inclusive o terminador zero. Destino deve ter espaco
; suficiente; as areas devem ser separadas. Consome os argumentos.
;-------------------------------------------------
STRCOPY:
