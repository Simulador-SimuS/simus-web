...
;------------------------------------------------------------
; Resultado do exemplo: 0x55AA contém 8 bits em '1'.
; Usamos prefixo 0x em ORG/EQU: o montador 0981-video
; não interpreta corretamente o sufixo H nessas diretivas.
ORG 0x200
COUNT_ONES:
     POP
     STA  RETURN_ADDRESS
